...
namespace RefactorName.Web
{
    public static class Util
    {
        ...
        internal static bool IsGreg(string greg)
        {
        ...
        /// <returns></returns>
        internal static string GetHigriDateWithFormat(DateTime? dateTime, string format)
        {
        ...
        /// <param name="format">date time format to use</param>
        /// <returns></returns>
        internal static string GetGregorianDateWithFormat(DateTime? dateTime, string format)
        {
            string result = String.Empty;
        ...
        /// <returns></returns>
        internal static string HijriToGreg(string hijri, string Format)
        {
            string[] allFormats ={"yyyy/MM/dd","yyyy/M/d",
            "dd/MM/yyyy","d/M/yyyy",
            "dd/M/yyyy","d/MM/yyyy","yyyy-MM-dd",
        ...
        /// <returns></returns>
        internal static DateTime ConvertStringToDateTime(string DateTimeIntigerFormat)
        {
            string[] allFormats ={"yyyy/MM/dd","yyyy/M/d",
            "dd/MM/yyyy","d/M/yyyy",
            "dd/M/yyyy","d/MM/yyyy","yyyy-MM-dd",
        ...
        internal static object CloneObject(object objSource)
        {
        ...
        internal static string SerializeXML<T>(T SerializedObject)
        {
            try
            {
        ...
        /// <returns>Empty string if any exception</returns>
        internal static string SerializeListXML<T>(List<T> serializedObjectLst)
        {
            try
            {
                StringBuilder xml = new StringBuilder();
        ...
        internal static T DeserializeItstring<T>(string SerializedObj)
        {
        ...
        /// <returns></returns>
        internal static List<T> DeserializeLst<T>(string serializedLstObj)
        {
        ...
        /// <returns></returns>
        internal static byte[] GetArrayFromFile(string PathToFile, bool deleteTheFile = true)
        {
        ...
        internal static void ByteArrayToFile(string fileName, byte[] byteArray)
        {
        ...
        internal static string ByteArrayToFileInTempFolder(byte[] byteArray, string Ext = ".pdf")
        {
        ...
        internal static string getProfilePhoto(byte[] originalImage)
        {
        ...
        internal static string RenderPartialViewToString(ControllerBase thisController, string viewName, object model)
        {
        ...
        /// <returns></returns>
        internal static SelectList EnumToSelectList<T>()
        {
        ...
        /// <returns></returns>
        internal static string GetDisplayName<T>(string value)
        {
            Type type = typeof(T);
        ...
        /// <returns></returns>
        internal static string GenerateComplexRandomCode(int length)
        {
        ...
        /// <returns></returns>
        internal static bool IsSAMobileNo(string mobileNo)
        {
            double res;
