...
namespace RefactorName.Core
{
    ...
    /// <summary>
    /// Represents error that occurs during persisting or retriving information from Repository.
    /// </summary>
    [Serializable]
    public class RepositoryException : Exception
    {
        /// <summary>
        /// Gets generic classification of access repository erros.
        /// </summary>
        public ErrorTypeEnum ErrorType { get; private set; }

        /// <summary>
        /// Gets business entity name that being persisted or retrived.
        /// </summary>
        ...
        /// </summary>
        /// <param name="entityName">business entity name that being persisted or retrived.</param>
        ...
        public RepositoryException(string entityName, ErrorTypeEnum errorType)
            : base(string.Format("Error [{0}] has been occured while retriving or persisting [{1}] entity.", entityName, errorType))
        {
        ...
        protected RepositoryException(SerializationInfo info, StreamingContext context)
            : base(info, context)
        {
            ErrorType = (ErrorTypeEnum)info.GetValue("ErrorType", typeof(ErrorTypeEnum));
        ...
        public override void GetObjectData(SerializationInfo info, StreamingContext context)
        {
            ...
            info.AddValue("ErrorType", ErrorType, typeof(ErrorTypeEnum));
